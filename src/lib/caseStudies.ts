import type { CaseStudyIllustrationVariant } from "@/components/illustrations/CaseStudyIllustration";

export interface CaseStudyTheme {
  colors: [string, string];
  illustration: CaseStudyIllustrationVariant;
}
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    theme: { colors: ["hsl(var(--teal))", "hsl(var(--indigo))"], illustration: "funnel-growth" },
    title: "Career Launchpad: Rebuilding Monetization From the Ground Up",
    category: "Monetization / 0-to-1 PLG Product",
    preview:
      "After a high-ticket placement product was shut down, building a low-ticket, AI-led, self-serve program that replaced it in months, not years.",
    metrics: ["1,000 paid learners · 2 months", "CAC down ~90%", "4 days → 10 mins time-to-activation"],
    context:
      "Placement Guarantee Courses (PGC) was a high-ticket, ops-heavy product line carrying a large share of company revenue. After an unfiltered admission audience degraded outcome quality, PGC was shut down. Internshala needed a new learner monetization model, and I owned building its replacement.",
    problem:
      "We had to replace a ₹1-2 crore/month high-touch product line with something that did not depend on sales headcount or ops load to run, without simply rebuilding the same fragile model under a new name.",
    whyHard:
      "Re-architecting monetization from high-ticket and human-delivered to low-ticket and self-serve inverts almost every assumption the old product was built on: pricing, activation, the support model, and a sales team that existed to run the old motion. None of that could be reused as-is.",
    whatIDid: [
      "Designed a low-ticket, AI-led, product-led-growth offering priced at ₹2,999",
      "Bundled AI mock interviews, AI resume analysis, and AI-driven job matching into a single program",
      "Combined the AI layer with project-based learning so the offering still produced a real outcome, not just automation",
      "Rebuilt activation and support around self-serve rather than a human sales/ops motion",
    ],
    solution:
      "A self-serve, AI-led program that replaced a sales-heavy, ops-heavy product with one that could scale without adding headcount, while still giving learners a placement-relevant outcome through AI tools and project work.",
    impact: [
      "1,000 paid learners in 2 months",
      "CAC down ~90% versus the previous high-ticket motion",
      "Time-to-activation dropped from 4 days to 10 minutes",
      "Weekly active learners up 40%",
      "33% of learners used two or more AI features",
    ],
    learnings: ["— add your reflection here —"],
  },
  {
    slug: "placement-guarantee-courses",
    theme: { colors: ["hsl(var(--indigo))", "hsl(var(--teal))"], illustration: "pmf-convergence" },
    title:
  ...
  {
    slug: "growth-funnel-overhaul",
    theme: { colors: ["hsl(var(--indigo))", "hsl(var(--teal))"], illustration: "conversion-funnel" },
  ...
  {
    slug: "rebuilding-the-learning-experience",
    theme: { colors: ["hsl(var(--teal))", "hsl(var(--indigo))"], illustration: "user-journey" },
  ...
  {
    slug: "competency-guardrails",
    theme: { colors: ["hsl(var(--indigo))", "hsl(var(--teal))"], illustration: "quality-filter" },
